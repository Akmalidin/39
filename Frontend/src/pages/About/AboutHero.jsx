    ...
    <>
      <section className="about__hero">
        <div className="container">
          <AboutHeroPropis
            title="Наша миссия"
            description="В нашей школе мы стремимся предоставить каждому ученику возможность раскрыть свои уникальные способности и достичь максимального потенциала. Мы создаем поддерживающую и вдохновляющую атмосферу, где каждый ребенок может развиваться как интеллектуально, так и творчески."
            img={mission}
          />
          <AboutHeroPropis
            title="Наш подход"
